...
import com.evervault.sdk.crypto.exceptions.Asn1EncodingException
import com.evervault.sdk.crypto.keys.points.Secp256r1Constants
...
internal class SharedSecretGenerator: ISharedSecretGenerator {

    private val provider = BouncyCastleProvider()

    override fun deriveSharedSecret(cageKey: Key): GeneratedSharedKey {
